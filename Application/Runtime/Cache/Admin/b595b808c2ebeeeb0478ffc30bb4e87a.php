...
<head>
    ...
    <link href="/myadmin/Public/Admin/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    ...
    <link href="/myadmin/Public/Admin/css/style.min.css?v=4.1.0" rel="stylesheet">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="/myadmin/Public/Admin/img/profile_small.jpg" /></span>
                ...
                <li>
                    <a class="J_menuItem" href="<?php echo U('Action/index');?>">
                        <i class="fa fa-columns"></i> <span class="nav-label">操作日志</span>
                    </a>
                </li>
                <li>
                    <a class="J_menuItem" href="<?php echo U('Aduser/index');?>">
                        <i class="fa fa-columns"></i> <span class="nav-label">管理员</span>
                    </a>
                </li>
...
<div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li class="m-t-xs">
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="/myadmin/Public/Admin/img/a7.jpg">
                                </a>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="/myadmin/Public/Admin/img/a4.jpg">
                                </a>
                                <div class="media-body ">
    ...
    <div class="row J_mainContent" id="content-main">
        <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo U('Index/index_v1');?>" frameborder="0" data-id="index_v1.html" seamless></iframe><!--左部文件-->
            ...
            <div id="tab-2" class="tab-pane">
                ...
                <div>
                    ...
                    <div class="sidebar-message">
                        <a href="#">
                            <div class="pull-left text-center">
                                <img alt="image" class="img-circle message-avatar" src="/myadmin/Public/Admin/img/a1.jpg">
                    ...
                    <div class="sidebar-message">
                        <a href="#">
                            <div class="pull-left text-center">
                                <img alt="image" class="img-circle message-avatar" src="/myadmin/Public/Admin/img/a2.jpg">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="sidebar-message">
                        <a href="#">
                            <div class="pull-left text-center">
                                <img alt="image" class="img-circle message-avatar" src="/myadmin/Public/Admin/img/a3.jpg">
                    ...
                    <div class="sidebar-message">
                        <a href="#">
                            <div class="pull-left text-center">
                                <img alt="image" class="img-circle message-avatar" src="/myadmin/Public/Admin/img/a4.jpg">
                            </div>
                    ...
                    <div class="sidebar-message">
                        <a href="#">
                            <div class="pull-left text-center">
                                <img alt="image" class="img-circle message-avatar" src="/myadmin/Public/Admin/img/a8.jpg">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="sidebar-message">
                        <a href="#">
                            <div class="pull-left text-center">
                                <img alt="image" class="img-circle message-avatar" src="/myadmin/Public/Admin/img/a7.jpg">
                            </div>
                            <div class="media-body">
...
<script src="/myadmin/Public/Admin/js/bootstrap.min.js?v=3.3.6"></script>
<script src="/myadmin/Public/Admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="/myadmin/Public/Admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="/myadmin/Public/Admin/js/plugins/layer/layer.min.js"></script>
<script src="/myadmin/Public/Admin/js/hplus.min.js?v=4.1.0"></script>
<script type="text/javascript" src="/myadmin/Public/Admin/js/contabs.min.js"></script>
<script src="/myadmin/Public/Admin/js/plugins/pace/pace.min.js"></script>
</body>
